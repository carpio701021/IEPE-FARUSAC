...
Route::group(['prefix' => 'aspirante'], function () {
    ...
    Route::group(['middleware' => 'aspirante_web'], function () {
        Route::post('/password/sendResetLink','Auth\PasswordController@sendResetLink');//componer rutas
        ...
        Route::get('/recursos/reglamento', 'RecursosController@getReglamento');
        Route::get('/recursos/guia-asignacion', 'RecursosController@viewGuiaAsignacion');
        Route::get('/recursos/guia-aplicacion', 'RecursosController@viewGuiaAplicacion');
