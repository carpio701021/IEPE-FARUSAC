        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ action('PasswordController@sendResetLink') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="glyphicon glyphicon-envelope"></i> Enviar enlace para resetear contraseña
                                </button>
                            </div>
                        </div>
                    </form>
