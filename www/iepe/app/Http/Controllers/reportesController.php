            ...
            $excel->sheet('First sheet', function($sheet) {
                ...
                foreach($consulta as $tupla){
                    $data[] = [
                        ...
                        'RV' => $tupla->nota_RV,
                        'APN' => $tupla->nota_APN,
                        'RA evaluado Arquitectura' => $tupla->percentil_RA,
                        'APE evaluado Arquitectura' => $tupla->percentil_APE,
                        'RV evaluado Arquitectura' => $tupla->percentil_RV,
                        'APN evaluado Arquitectura' => $tupla->percentil_APN,
                        'RA evaluado Diseño' => $tupla->percentil_RA_disenio,
                        'APE evaluado Diseño' => $tupla->percentil_APE_disenio,
                        'RV evaluado Diseño' => $tupla->percentil_RV_disenio,
                        'APN evaluado Diseño' => $tupla->percentil_APN_disenio,
