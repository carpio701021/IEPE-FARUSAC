...
<div class="container">
    <ul class="list-group">
        <li class="list-group-item active clearfix">
            <h2 class="panel-title pull-left" style="padding-top: 7.5px;">Usuarios Administrativos Eliminados</h2>
            <div class="btn-group pull-right">
                <a href="{{ action('GestionUsuariosController@index') }}" class="btn btn-default"><span class="glyphicon glyphicon-menu-left"></span> Usuarios activos</a>
            </div>
        </li>
                ...
                <li id="li{{ $admin->registro_personal }}" class="list-group-item">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <b>Fecha de eliminación:</b> {{ $admin->deleted_at }}
                        </div>

                        <div class="col-md-4">
                            <a href="{{ action('GestionUsuariosController@restoreAdmin',['id'=>$admin->registro_personal]) }}"><span class="glyphicon glyphicon-open"></span> Restaurar</a><br>
                        </div>
                    </div>
